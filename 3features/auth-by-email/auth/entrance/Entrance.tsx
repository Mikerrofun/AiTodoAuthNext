...
import { useEntrance } from "./Entrance.hook";
import { AuthNavLink } from "@/5shared/ui/AuthNavLink/AuthNavLink";

export function Entrance() {
  const { register, handleOnSubmit, errors, serverError, isSubmitting, handleOAuthSignIn } =
    useEntrance();

  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-md p-8">
        <h1 className="text-2xl font-semibold text-center text-gray-800 mb-6">Вход</h1>
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="flex items-center justify-center gap-3 border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
          >
        ...
        <div className="mt-6">
          <AuthNavLink text="Нет аккаунта?" linkText="Зарегистрироваться" href="/register" />
        </div>
      </div>
    </div>
  );
